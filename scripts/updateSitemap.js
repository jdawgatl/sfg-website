...
const routes = [
  ...
  { path: '/products/auto', priority: 0.9, changefreq: 'monthly' },
  { path: '/products/home', priority: 0.8, changefreq: 'monthly' },
  { path: '/products/commercial', priority: 0.8, changefreq: 'monthly' },
  { path: '/products/bonds', priority: 0.9, changefreq: 'monthly' },
  { path: '/quote', priority: 0.9, changefreq: 'weekly' },
  { path: '/contact', priority: 0.8, changefreq: 'monthly' },
  { path: '/blog', priority: 0.7, changefreq: 'weekly' },
  { path: '/georgia-insurance', priority: 0.8, changefreq: 'monthly' },
  { path: '/tennessee-auto-insurance', priority: 0.8, changefreq: 'monthly' },
  { path: '/mississippi-home-insurance', priority: 0.8, changefreq: 'monthly' },
  { path: '/privacy', priority: 0.5, changefreq: 'yearly' },
  { path: '/surety-bonds', priority: 0.9, changefreq: 'weekly' },
  { path: '/landing/title-bonds', priority: 0.9, changefreq: 'weekly' },
];
