...
export const ConsentCheckbox = ({ onCheckedChange }: ConsentCheckboxProps) => {
  return (
    <div className="flex items-center space-x-2">
      <Checkbox id="consent" onCheckedChange={checked => onCheckedChange(checked as boolean)} required />
